    ...
    Public Partial Class Form1
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Else
                ...
                text = "Free time interval equal to " & clientFreeInterval.Duration.ToString() & " is found! " & Microsoft.VisualBasic.Constants.vbLf & Microsoft.VisualBasic.Constants.vbCr & " It starts on " & clientFreeInterval.Start.Date.ToShortDateString() & " at " & clientFreeInterval.Start.TimeOfDay.ToString() & "."
